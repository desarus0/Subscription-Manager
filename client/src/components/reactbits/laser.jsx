...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    setSizeNow();
    // clientWidth/clientHeight may be 0 on first synchronous call before layout commits.
    // Force a re-measure after the first paint regardless of whether ResizeObserver fires.
